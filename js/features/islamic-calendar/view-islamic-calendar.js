export class IslamicCalendarView {
    ...
    render(container) {
        ...
        container.innerHTML = `
            <div class="container" dir="${rtl ? 'rtl' : 'ltr'}">
    ...
    renderMonthCalendar(trans, rtl) {
        ...
        return `
            <div class="card mb-6" style="animation: fadeIn 0.3s ease-in;" dir="${rtl ? 'rtl' : 'ltr'}">
    ...
    renderUpcomingEvents(trans, rtl) {
        ...
        return `
            <div id="upcoming-events-section" class="card mb-6" style="animation: fadeIn 0.3s ease-in;" dir="${rtl ? 'rtl' : 'ltr'}">
