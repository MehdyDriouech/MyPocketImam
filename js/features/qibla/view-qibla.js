export class QiblaView {
    ...
    render(container) {
        ...
        container.innerHTML = `
            <div class="container" style="position: relative;" dir="${rtl ? 'rtl' : 'ltr'}">
                    <!-- Header -->
                    <div class="app-header mb-8 rounded-xl" dir="${rtl ? 'rtl' : 'ltr'}">
                        ...
                        <h1 class="app-title">${trans.qiblaDirection || 'Direction Qibla'}</h1>
                        <div style="width: 24px;"></div>
                    </div>

                    <!-- Compass Section -->
                    <div class="flex flex-col items-center justify-center" style="gap: 2rem; animation: fadeIn 0.3s ease-in;">
