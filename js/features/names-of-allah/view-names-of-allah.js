export class NamesOfAllahView {
    ...
    renderList() {
      ...
      <div class="container p-4">
        <div class="app-header mb-6 sticky top-0 z-10 py-2 backdrop-blur-sm rounded-xl">
            <button data-action="nav-home" class="btn btn-secondary">
                <span>◀</span> ${t.back || 'Retour'}
            </button>
            <h2 class="font-bold text-xl text-gray-800">${t.allNames || 'Tous les Noms'}</h2>
            <div class="w-20"></div>
        </div>
    ...
    renderFavorites() {
      ...
      <div class="container p-4">
        <div class="app-header mb-6 rounded-xl">
            ...
            <h2 class="font-bold text-xl text-gray-800">❤️ ${t.myFavorites || 'Mes Favoris'}</h2>
            <div class="w-20"></div>
        </div>
    ...
    renderLearning() {
      ...
      <div class="container p-4 min-h-screen flex flex-col">
        <div class="app-header mb-6 rounded-xl">
            ...
            <div class="px-4 py-1 rounded-full text-sm font-medium text-muted" style="background: var(--bg-color);">
                Progression: ${learnedCount} / ${total}
            </div>
        </div>
